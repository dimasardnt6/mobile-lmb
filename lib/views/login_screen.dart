  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      if (response.code == 200 && response.status == true) {
        if (response.data!.id_level == '5') {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => const DashboardPengemudi()),
          );
        } else if (response.data!.id_level == '77' ||
            response.data!.id_level == '1') {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => const DashboardAdmin()),
          );
        } else if (response.data!.id_level == '14') {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => const DashboardPpa()),
          );
        } else {
          Navigator.pushReplacement(
            context,
