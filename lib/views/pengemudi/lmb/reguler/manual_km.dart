...
class ManualKm extends StatefulWidget {
  final LmbDriverNewData lmbDriverNew;

  const ManualKm({Key? key, required this.lmbDriverNew}) : super(key: key);

  @override
  State<ManualKm> createState() => _ManualKmState();
}

class _ManualKmState extends State<ManualKm> {
  ...
  Future<void> _handlePostLmbManualKm() async {
    ...
    final String? cuser = prefs.getString('user_id');
    final String? kode_layanan = widget.lmbDriverNew.kode_layanan;
