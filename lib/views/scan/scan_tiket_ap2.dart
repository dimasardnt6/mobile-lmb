...
class ScanTiketAp2 extends StatefulWidget {
  const ScanTiketAp2({Key? key}) : super(key: key);

  @override
  State<ScanTiketAp2> createState() => _ScanTiketAp2State();
}

class _ScanTiketAp2State extends State<ScanTiketAp2> {
  String? scanResult;
